<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/Master.Master"
    AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="WebHomeDepot.Inicio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <table id="jqGrid" class="table table-bordered table-hover" style="font-family: 'Roboto' ,'Arial';">
        </table>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control-plaintext  border-bottom" aria-describedby="emailHelp borde"
                    id="txtExcel" placeholder="Escriba Nombre Excel...">
                <small id="emailHelp" class="form-text text-muted">Nombre del Archivo con extensión
                    (.xls) o (.xlsx)</small>
            </div>
        </div>
        ...
        <button id="btProcesar" type="button" class="btn btn-lg btn-outline-info"><i class='fas fa-cogs'>
        </i>&nbspProcesar</button>
